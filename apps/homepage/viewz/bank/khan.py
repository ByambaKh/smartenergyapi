    ...
    try:
        ...
        if xml_req.tag == 'KHAN01':
            ...
            if cus is not None:
                ...
                etree.SubElement(xml_res, "City").text = Aimag.objects.filter(code=address.aimag_code).first().name
                etree.SubElement(xml_res, "Dist").text = Duureg.objects.filter(code=address.duureg_code).first().name
                etree.SubElement(xml_res, "Khoroo").text = Horoo.objects.filter(code=address.horoo_code).first().name
                ...
                etree.SubElement(xml_res, "ResponseCode").text = '201'
                etree.SubElement(xml_res, "ResponseDesc").text = 'Хэрэглэгчийн мэдээлэл олдсонгүй'

        elif xml_req.tag == 'KHAN03':
            xml_res = etree.Element("KHAN03Res")
                ...
                if cus.customer_angilal == '1':
                    ...
                    if str(cus.code) not in not_ebarimt:
                        ...
                        if last_avlaga is not None:
                            ...
                            etree.SubElement(xml_res, "UserCode").text = str(cus_code)
                            etree.SubElement(xml_res, "ResponseCode").text = '0'
                            etree.SubElement(xml_res, "ResponseDesc").text = 'Амжилттай'
                            etree.SubElement(xml_res, "BillID").text = last_year + last_month + str(cus_code)
                            etree.SubElement(xml_res, "Amount").text = str(round(amount, 2))
                            etree.SubElement(xml_res, "VATAmount").text = str(round(((float(amount) / 1.1) * 0.1), 2))
                            etree.SubElement(xml_res, "CurCode").text = "MNT"
                            etree.SubElement(xml_res, "BillStartDate").text = befo_bich_date
                            etree.SubElement(xml_res, "BillEndDate").text = last_bich_date
                            etree.SubElement(xml_res, "BillDescription").text = last_year + "-" + last_month + " сарын цахилгааны төлбөр"

                            res_bill_detail_list = etree.SubElement(xml_res, "BillDetailList")

                            if cus.customer_angilal == '0':
                                res_bill_detail_list_item = etree.SubElement(res_bill_detail_list, "BillDetailListItem")
                                etree.SubElement(res_bill_detail_list_item, "Code").text = "KHN00"
                            ...
                            if int(last_avlaga.month) <= 3 and int(last_avlaga.year) <= 2018:
                                ...
                                for last_bich in last_bichs:
                                    ...
                                    if len(list(last_bichs)) <= 2:
                                        if before_bich is not None:
                                            res_bill_detail_list_item = etree.SubElement(res_bill_detail_list, "BillDetailListItem")
                                            etree.SubElement(res_bill_detail_list_item, "Code").text = "KHN0" + str(detail_counter)
                                ...
                                if counter > 2:
                                    res_bill_detail_list_item = etree.SubElement(res_bill_detail_list, "BillDetailListItem")
                                    etree.SubElement(res_bill_detail_list_item, "Code").text = "KHN07"
                                ...
                                res_bill_detail_list_item = etree.SubElement(res_bill_detail_list, "BillDetailListItem")
                                etree.SubElement(res_bill_detail_list_item, "Code").text = "KHN08"
                                ...
                                if payment < 0:
                                    res_bill_detail_list_item = etree.SubElement(res_bill_detail_list, "BillDetailListItem")
                                    etree.SubElement(res_bill_detail_list_item, "Code").text = "KHN09"
                                    etree.SubElement(res_bill_detail_list_item, "Name").text = "Энэ сарын орлого"
                                    etree.SubElement(res_bill_detail_list_item, "Value").text = str(payment * -1)
                                    etree.SubElement(res_bill_detail_list_item, "Description").text = "Энэ сарын орлого"

                                if heregleenii_tulbur > 0:
                                    res_bill_detail_list_item = etree.SubElement(res_bill_detail_list, "BillDetailListItem")
                                    etree.SubElement(res_bill_detail_list_item, "Code").text = "KHN10"
                                ...
                                if last_avlaga.uilchilgeenii_tulbur is not None and Decimal(last_avlaga.uilchilgeenii_tulbur) > 0:
                                    res_bill_detail_list_item = etree.SubElement(res_bill_detail_list, "BillDetailListItem")
                                    etree.SubElement(res_bill_detail_list_item, "Code").text = "KHN11"
                                ...
                                if suuri_price > 0:
                                    res_bill_detail_list_item = etree.SubElement(res_bill_detail_list, "BillDetailListItem")
                                    etree.SubElement(res_bill_detail_list_item, "Code").text = "KHN12"
                                ...
                                if chadal_price > 0:
                                    res_bill_detail_list_item = etree.SubElement(res_bill_detail_list, "BillDetailListItem")
                                    etree.SubElement(res_bill_detail_list_item, "Code").text = "KHN13"
                                ...
                                res_bill_detail_list_item = etree.SubElement(res_bill_detail_list, "BillDetailListItem")
                                etree.SubElement(res_bill_detail_list_item, "Code").text = "KHN14"
                                ...
                                if last_avlaga.barimt_une is not None and Decimal(last_avlaga.barimt_une) > 0:
                                    res_bill_detail_list_item = etree.SubElement(res_bill_detail_list, "BillDetailListItem")
                                    etree.SubElement(res_bill_detail_list_item, "Code").text = "KHN15"
                                ...
                                if tooluur_histories is not None:
                                    ...
                                    for tooluur_history in tooluur_histories:
                                        ...
                                        if len(list(tooluur_histories)) <= 2:
                                            res_bill_detail_list_item = etree.SubElement(res_bill_detail_list, "BillDetailListItem")
                                            etree.SubElement(res_bill_detail_list_item, "Code").text = "KHN0" + str(det_counter)
                                    ...
                                    if last_avlaga.uilchilgeenii_tulbur is not None and Decimal(
                                            last_avlaga.uilchilgeenii_tulbur) > 0:
                                        res_bill_detail_list_item = etree.SubElement(res_bill_detail_list, "BillDetailListItem")
                                        etree.SubElement(res_bill_detail_list_item, "Code").text = "KHN11"
                                        etree.SubElement(res_bill_detail_list_item, "Name").text = "Төлбөрт үйлчилгээ"
                                        etree.SubElement(res_bill_detail_list_item, "Value").text = str(last_avlaga.uilchilgeenii_tulbur)
                            ...
                            etree.SubElement(xml_res, "UserCode").text = cus_code
                            etree.SubElement(xml_res, "ResponseCode").text = '302'
                            etree.SubElement(xml_res, "ResponseDesc").text = 'Хэрэглэгчид төлөх билл байхгүй'
                    else:
                        etree.SubElement(xml_res, "UserCode").text = cus_code
                        etree.SubElement(xml_res, "ResponseCode").text = '302'
                        etree.SubElement(xml_res, "ResponseDesc").text = 'Хэрэглэгчид төлөх билл байхгүй'
                    ...
                    etree.SubElement(xml_res, "UserCode").text = cus_code
                    etree.SubElement(xml_res, "ResponseCode").text = '303'
                    etree.SubElement(xml_res, "ResponseDesc").text = 'ААН төлбөр төлөх боломжгүй байна.'
            else:
                etree.SubElement(xml_res, "ResponseCode").text = '301'
                etree.SubElement(xml_res, "ResponseDesc").text = 'Хэрэглэгчийн мэдээлэл олдсонгүй'

        elif xml_req.tag == 'KHAN04':
            xml_res = etree.Element("KHAN04Res")

            txn_date = xml_req.TrnDate.text
            cus_code = xml_req.UserCode.text
            journalid = xml_req.JournalID.text
            ...
            if cur == 'MNT':
                if total > 0:
                    ...
                    if customer is not None:
                        ...
                        his.bank = Bank.objects.filter(code='1').first()
                        ...
                        etree.SubElement(xml_res, "ResponseCode").text = '402'
                        etree.SubElement(xml_res, "ResponseDesc").text = 'Хэрэглэгчийн төлөх биллийн мэдээлэл олдсонгүй'
                else:
                    etree.SubElement(xml_res, "ResponseCode").text = '403'
                    etree.SubElement(xml_res, "ResponseDesc").text = 'Гүйлгээний дүн буруу'
            else:
                etree.SubElement(xml_res, "ResponseCode").text = '404'
                etree.SubElement(xml_res, "ResponseDesc").text = 'Гүйлгээний валют буруу'

    except etree.XMLSyntaxError:
        etree.SubElement(xml_res, "ResponseCode").text = '400'
        etree.SubElement(xml_res, "ResponseDesc").text = 'Бичилтийн алдаа'
