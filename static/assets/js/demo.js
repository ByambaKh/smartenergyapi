...
demo = {
	...
	shwBalanceSuccessDialog: function(type, count, changed_count){
        swal({  title: "Амжилттай",
            text: "Нийт " + count +" бичилтээс " +changed_count+ "-д баланс тооцов.",
            type: "success"
        });
	},
